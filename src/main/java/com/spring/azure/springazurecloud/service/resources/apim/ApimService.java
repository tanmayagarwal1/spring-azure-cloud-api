package com.spring.azure.springazurecloud.service.resources.apim;
...
public class ApimService {
    ...
    public Apim getAllApim(ApimRequestDto dto, String username){
        if(!validationService.validateExistsMainResource(Apim.class, dto.getApimId(), username))
    ...
    public Api getAllApis(ApimRequestDto dto, String username){
        if(!validationService.validateExistsResource(dto.getApimId(), Apim.class))
    ...
    public<T extends Resource> void deleteApimResource(ApimRequestDto dto, String username, Class<T> clazz){
        if(!validationService.validateExistsMainResource(Apim.class, dto.getApimId(), username)) throw new ApimException("No APIM Found");
