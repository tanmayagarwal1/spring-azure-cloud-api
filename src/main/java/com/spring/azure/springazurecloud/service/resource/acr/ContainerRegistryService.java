...
public class ContainerRegistryService {
    ...
    private final ContainerRegistryValidationService validationService;

    public ContainerRegistry getContainerRegistry(ContainerRegistryDto dto, String username){
        if(!validationService.validateExistsContainerRegistry(dto.getContainerRegistryId(), username))
